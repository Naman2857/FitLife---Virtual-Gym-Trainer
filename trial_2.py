...
actions = np.array(['', 'OH-Press', 'Neutral'])
...
cap = cv2.VideoCapture(r"C:/Users/HP/Downloads/GYM-Exercise-Detection-and-Counting-main/GYM-Exercise-Detection-and-Counting-main/1.mp4")
